...
class TaskOpt(Region):
    ...
    date = Element(By.CSS_SELECTOR, ' [data-qa="edo3-Document_docDate"] [class="controls-EditableArea__Text__inner"]', 'Дата')
    number = Element(By.CSS_SELECTOR, '[data-qa="edo3-Document_docNumber"] [class="controls-EditableArea__Text__inner"]', 'Номер')
...
#     url_task = Link(By.LINK_TEXT, 'https://fix-online.sbis.ru/doc/95af7896-630f-4e68-b9ca-ae8f1b1b7ef8?client=6242047', 'ссылка на задачу')
