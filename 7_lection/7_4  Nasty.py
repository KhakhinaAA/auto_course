...
class RomanNums:
    ...
    def from_roman(self):
        ...
        for char in reversed(self.roman_numeral):
            current_value = self.roman_to_arabic_map.get(char, 0)
    ...
    def is_palindrome(self):
        """Проверка, является ли арабская форма числа палиндромом"""
        arabic_number = str(self.from_roman())
        return arabic_number == arabic_number[::-1]
